      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex flex-col items-center pt-28 pb-12 px-4 sm:px-6">
        ...
        <div className="text-center mb-12 max-w-3xl relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Book Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-amber-600">Birthday</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Let's capture the magic of your child's special day with our professional photography services.
          </p>
        </div>
          ...
          <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-700">
            <div>
              <h2 className="text-2xl font-bold text-white">
                {selectedPackage?.name || 'Birthday Package'}
              </h2>
            ...
            {[ 
              ...
              { 
                ...
                options: [
                  ...
                  { value: 'Pirate', label: '🏴‍☠️ Pirate Adventure' },
