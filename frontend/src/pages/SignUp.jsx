...
const SignUp = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_BASE_URL}/UserOperations/register`, payload);
  ...
  const handleResendVerification = async () => {
    try {
      setIsSubmitting(true);
      await axios.post(`${process.env.REACT_APP_API_BASE_URL}/UserOperations/resend-verification`, {
