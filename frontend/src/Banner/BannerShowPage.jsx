...
//       try {
//         const response = await axios.get('http://localhost:4000/Banner/active');
...
//   // Auto-rotate banners only if we have valid banners
//   useEffect(() => {
...
//     }
//   }, [banners]); // Changed dependency to banners instead of banners.length
...
//   // Additional check to ensure banners is an array before mapping
//   if (!Array.isArray(banners) ){
//     console.error('Banners is not an array:', banners);
//     setBanners([]); // Reset to empty array
//     return (
//       <div className="relative min-h-[400px] flex items-center justify-center">
//         <div className="bg-red-500/20 border border-red-500/30 rounded-xl p-6 max-w-md mx-auto">
...
//                 e.target.className = 'w-full h-full object-contain bg-black/50 p-10';
//               }}
//             />
//           </div>
//         ))}
