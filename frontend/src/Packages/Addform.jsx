...
//   const [categories, setCategories] = useState(['Wedding', 'Birthday', 'Photoshoot', 'Party']);
...
//     if (name === 'category' && value === 'Add option') {
//       setShowNewCategoryInput(true);
//       setPackageData(prev => ({ ...prev, [name]: '' }));
//     } else if (name === 'category') {
//       setShowNewCategoryInput(false);
//       setPackageData(prev => ({ ...prev, [name]: value }));
//     } else if (name === 'type' && value === 'Add option') {
...
//     setPackageData(prev => ({ ...prev, photo: e.target.value }));
//   };
...
//         }
//         packageData.category = newCategory;
//       }
...
//       formData.append('descriptionPoints', JSON.stringify(packageData.descriptionPoints));
//       formData.append('category', packageData.category);
//       formData.append('type', packageData.type);

//       const response = await axios.post('http://localhost:4000/PackageOperation', formData, {
//         headers: {
...
//     const response = await axios.post('http://localhost:4000/ProductOperation', formData, {
//       headers: {
//         'Content-Type': 'multipart/form-data',
//       }
//     });
...
//                             onClick={() => {
//                               setShowNewCategoryInput(false);
//                               setPackageData(prev => ({ ...prev, category: 'Wedding' }));
//                             }}
...
//       const response = await axios.post('http://localhost:4000/PackageOperation', {
