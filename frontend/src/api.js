...
export const API_ENDPOINTS = {
  ...
  BANNERS: {
    ...
    GET_BY_ID: (id) => `${API_BASE_URL}/Banner/${id}`,
    UPDATE: (id) => `${API_BASE_URL}/Banner/${id}`,
  ...
  USERS: {
    ...
    UPDATE_PROFILE: (userId) => `${API_BASE_URL}/UserOperations/update/${userId}`,
  },

  BOOKINGS: {
    WEDDING: `${API_BASE_URL}/weddingBooking`,
    BIRTHDAY: `${API_BASE_URL}/birthdayBooking`,
    PUBERTY: `${API_BASE_URL}/pubertyBooking`,
    GET_WEDDING: (id) => `${API_BASE_URL}/weddingBooking/${id}`,
    GET_BIRTHDAY: (id) => `${API_BASE_URL}/birthdayBooking/${id}`,
    GET_PUBERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
    CREATE_WEDDING: `${API_BASE_URL}/weddingBooking`,
    CREATE_BIRTHDAY: `${API_BASE_URL}/birthdayBooking`,
    CREATE_PUBERTY: `${API_BASE_URL}/pubertyBooking`,
    UPDATE_WEDDING: (id) => `${API_BASE_URL}/weddingBooking/${id}`,
    UPDATE_BIRTHDAY: (id) => `${API_BASE_URL}/birthdayBooking/${id}`,
    UPDATE_PUBERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
    DELETE_WEDDING: (id) => `${API_BASE_URL}/weddingBooking/${id}`,
    DELETE_BIRTHDAY: (id) => `${API_BASE_URL}/birthdayBooking/${id}`,
    DELETE_PUBERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
    USER_WEDDING: (userId) => `${API_BASE_URL}/weddingBooking/user/${userId}`,
    USER_BIRTHDAY: (userId) => `${API_BASE_URL}/birthdayBooking/user/${userId}`,
    USER_PUBERTY: (userId) => `${API_BASE_URL}/pubertyBooking/user/${userId}`,
    USER_PROPERTY: (userId) => `${API_BASE_URL}/pubertyBooking/user/${userId}`,
    GET_PROPERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
    CREATE_PROPERTY: `${API_BASE_URL}/pubertyBooking`,
    UPDATE_PROPERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
    DELETE_PROPERTY: (id) => `${API_BASE_URL}/pubertyBooking/${id}`,
  },
  ...
  EXPENSES: {
    ALL: `${API_BASE_URL}/ExpenseController/getpay`,
    SINGLE: (id) => `${API_BASE_URL}/ExpenseController/getpay/${id}`,
    CREATE: `${API_BASE_URL}/ExpenseController/Pay`,
    UPDATE: (id) => `${API_BASE_URL}/ExpenseController/updatepay/${id}`,
    DELETE: (id) => `${API_BASE_URL}/ExpenseController/deletePay/${id}`,
  },
};
